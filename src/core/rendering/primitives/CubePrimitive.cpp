...
{
    _mesh.addPosition(glm::vec3(-1, -1, -1)).addNormal(glm::vec3(0, 0, -1))
		.addPosition(glm::vec3(-1, 1, -1)).addNormal(glm::vec3(0, 0, -1))
		.addPosition(glm::vec3(1, 1, -1)).addNormal(glm::vec3(0, 0, -1))
		.addPosition(glm::vec3(1, -1, -1)).addNormal(glm::vec3(0, 0, -1))
		...
		.addPosition(glm::vec3(-1, -1, -1)).addNormal(glm::vec3(0, -1, 0))
		.addPosition(glm::vec3(-1, -1, 1)).addNormal(glm::vec3(0, -1, 0))
		.addPosition(glm::vec3(1, -1, 1)).addNormal(glm::vec3(0, -1, 0))
		.addPosition(glm::vec3(1, -1, -1)).addNormal(glm::vec3(0, -1, 0))
		...
		.addPosition(glm::vec3(-1, -1, -1)).addNormal(glm::vec3(-1, 0, 0))
		.addPosition(glm::vec3(-1, -1, 1)).addNormal(glm::vec3(-1, 0, 0))
		.addPosition(glm::vec3(-1, 1, 1)).addNormal(glm::vec3(-1, 0, 0))
		.addPosition(glm::vec3(-1, 1, -1)).addNormal(glm::vec3(-1, 0, 0))
